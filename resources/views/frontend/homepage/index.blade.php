                    ...
                    <div class="row">
                        <div class="col-md-4 position-relative">
                            <div class="p-3 text-center">
                                <h1 class="text-gradient text-dark"><span id="state1" countTo="70">170</span>+</h1>
                                <h5 class="mt-3">Anggota</h5>
                                <p class="text-sm font-weight-normal">Terdapat 170+ apoteker aktif dalam organisasi ini.
                                </p>
                            </div>
                    ...
                    <div class="row justify-content-start">
                        ...
                        <div class="col-md-6">
                            <div class="info">
                                ...
                                <p class="pe-3" style="text-align: justify;">Menjadi teladan dalam kejujuran, tanggung
                    ...
                    <div class="row justify-content-start mt-5">
                        ...
                        <div class="col-md-6 mt-3">
                            <div class="info">
                                ...
                                <p class="pe-3" style="text-align: justify;">Menumbuhkan budaya empati dan kepedulian
