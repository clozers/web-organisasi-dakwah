...
<style>
    ...
    .news-header {
        ...
        url('{{ asset(' assets_frontend/img/apoteker-4.png') }}') center/cover;
        height: 50vh;
        display: flex;
        align-items: center;
            ...
            <div class="row mb-5 text-center">
                <div class="col-lg-8 mx-auto">
                    ...
                    <p class="text-muted p-horizontal">Temukan berita, artikel, dan informasi menarik seputar kegiatan
                        apoteker, pengembangan profesi, serta kebijakan terbaru di bidang kefarmasian.</p>
                </div>
            </div>
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="card news-card shadow-sm h-100">
                        <a href="#">
                            <img src="{{ asset('assets_frontend/img/apoteker.png') }}" class="card-img-top"
                                alt="Judul Berita 1">
                        </a>
                        <div class="card-body">
                            <h5 class="fw-bold">Judul Berita 1</h5>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="card news-card shadow-sm h-100">
                        ...
                        <div class="card-body">
                            <h5 class="fw-bold">Judul Berita 2</h5>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="card news-card shadow-sm h-100">
                        ...
                        <div class="card-body">
                            <h5 class="fw-bold">Judul Berita 3</h5>
